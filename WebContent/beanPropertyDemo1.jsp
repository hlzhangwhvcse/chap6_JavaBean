...
<html>
	<head>
		<title>JavaBean演示:beanPropertyDemo1</title>
	</head>
	<body>
	    scope参数的应用范围：
	    <br>
		...
		<jsp:forward page="beanPropertyDemo2.jsp" >
			<jsp:param name="" value="" />
		</jsp:forward>
		<br>说明：beanPropertyDemo.jsp页面执行forward标签跳转到beanPropertyDemo1.jsp页面后，仍是同一个application、同一个session，同一个request，但是不同的页面
	</body>
</html>